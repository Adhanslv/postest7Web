...
<body>
    <a href="logout.php"><button class="tambah" ><i class="fa-solid fa-right-from-bracket"></i> Logout    </button></a>
    <div class="searching">
            <form action="search.php" method="POST" >
                <input type="text" name="" placeholder="cari data" class="search">
                <input type="submit" name="cari" value="cari" class="cari" href="search.php">
            </form>
    </div>
